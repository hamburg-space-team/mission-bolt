...
// Wraps ARM_DRIVER_I2C with a higher-level register-oriented API.
// Encapsulates bus initialization, timeout handling, and repeated-start write-read.
class CmsisI2CBus {
  public:
    ...
    // Initialize the underlying CMSIS driver and bring it to full power.
    // Must be called once before any read/write. Returns 0 on success.
    [[nodiscard]] int init();
