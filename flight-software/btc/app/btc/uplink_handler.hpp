...
/// Classify an inbound uplink command opcode into the ACK status the BTC
/// returns. Pure decision logic; the command actions themselves are still a
/// no-op for now (the ACK confirms receipt).
///
/// @ingroup apps
